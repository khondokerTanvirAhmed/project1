        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <div class="probootstrap-slider-text text-center">
              <h1 class="probootstrap-heading probootstrap-animate mb20" data-animate-effect="fadeIn">100% Support</h1>
              <div class="probootstrap-animate probootstrap-sub-wrap mb30" data-animate-effect="fadeIn"> Lorem ipsum loren dolon Lorem ipsum loren dolonLorem ipsum loren dolon blah blah </div>
            </div>
          </div>
        </div>
      </div>
